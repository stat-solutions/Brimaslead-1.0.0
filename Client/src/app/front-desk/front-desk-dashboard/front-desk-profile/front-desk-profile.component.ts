...
@Component({
  selector: "app-front-desk-profile",
  templateUrl: "./front-desk-profile.component.html",
  styleUrls: ["./front-desk-profile.component.scss"],
})
export class FrontDeskProfileComponent implements OnInit {

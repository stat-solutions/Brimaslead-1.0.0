...
@Component({
  selector: "app-front-desk-reports",
  templateUrl: "./front-desk-reports.component.html",
  styleUrls: ["./front-desk-reports.component.scss"],
})
export class FrontDeskReportsComponent implements OnInit {
  registered = false;
  submitted = false;
  errored = false;
  posted = false;

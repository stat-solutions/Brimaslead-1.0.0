...
@Component({
  ...
  templateUrl: './content-section-finance.component.html',
  styleUrls: ['./content-section-finance.component.scss']
})
export class ContentSectionFinanceComponent implements OnInit {

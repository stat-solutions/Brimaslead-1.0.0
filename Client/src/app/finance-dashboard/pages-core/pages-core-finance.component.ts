...
@Component({
  selector: 'app-pages-core-finance',
  templateUrl: './pages-core-finance.component.html',
  styleUrls: ['./pages-core-finance.component.scss']
})
export class PagesCoreFinanceComponent implements OnInit {
  setNavLayout: string;
  themeLayout: string;

...
@Component({
  selector: 'app-pages-core-admini',
  templateUrl: './pages-core-admini.component.html',
  styleUrls: ['./pages-core-admini.component.scss']
})
export class PagesCoreadminiComponent implements OnInit {
  setNavLayout: string;
  themeLayout: string;

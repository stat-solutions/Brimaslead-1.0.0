...
@Component({
  ...
  templateUrl: './content-section-procurement.component.html',
  styleUrls: ['./content-section-procurement.component.scss']
})
export class ContentSectionProcurementComponent implements OnInit {

...
import { AuthServiceService } from '../../../shared/services/auth-services/auth-service.service';
import { Router } from '@angular/router';
import { ToastrService } from 'ngx-toastr';

@Component({
  selector: "app-header",
  templateUrl: "./header-procurement.component.html",
  styleUrls: ["./header-procurement.component.scss"],
})
export class HeaderProcurementComponent implements OnInit {

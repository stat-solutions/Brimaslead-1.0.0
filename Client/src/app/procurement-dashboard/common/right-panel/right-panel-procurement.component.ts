...
@Component({
  ...
  templateUrl: './right-panel-procurement.component.html',
  styleUrls: ['./right-panel-procurement.component.scss'],
})
export class RightPanelProcurementComponent implements OnInit {

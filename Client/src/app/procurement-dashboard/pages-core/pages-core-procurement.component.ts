...
@Component({
  selector: 'app-pages-core-procurement',
  templateUrl: './pages-core-procurement.component.html',
  styleUrls: ['./pages-core-procurement.component.scss']
})
export class PagesCoreProcurementComponent implements OnInit {
  setNavLayout: string;
  themeLayout: string;

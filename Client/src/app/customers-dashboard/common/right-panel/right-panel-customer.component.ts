...
@Component({
  ...
  templateUrl: './right-panel-customer.component.html',
  styleUrls: ['./right-panel-customer.component.scss'],
})
export class RightPanelCustomerComponent implements OnInit {

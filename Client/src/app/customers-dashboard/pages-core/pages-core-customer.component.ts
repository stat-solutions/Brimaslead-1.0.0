...
@Component({
  selector: 'app-pages-core-customer',
  templateUrl: './pages-core-customer.component.html',
  styleUrls: ['./pages-core-customer.component.scss']
})
export class PagesCoreCustomerComponent implements OnInit {
  setNavLayout: string;
  themeLayout: string;

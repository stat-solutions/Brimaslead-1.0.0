...
@Component({
  ...
  templateUrl: './content-section-customer.component.html',
  styleUrls: ['./content-section-customer.component.scss']
})
export class ContentSectionCustomerComponent implements OnInit {

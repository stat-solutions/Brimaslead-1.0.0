...
@Component({
  ...
  templateUrl: './right-panel-trans-logistics.component.html',
  styleUrls: ['./right-panel-trans-logistics.component.scss'],
})
export class RightPanelTransLogisticsComponent implements OnInit {

...
@Component({
  selector: 'app-pages-core-trans-logistics',
  templateUrl: './pages-core-trans-logistics.component.html',
  styleUrls: ['./pages-core-trans-logistics.component.scss']
})
export class PagesCoreTransLogisticsComponent implements OnInit {
  setNavLayout: string;
  themeLayout: string;

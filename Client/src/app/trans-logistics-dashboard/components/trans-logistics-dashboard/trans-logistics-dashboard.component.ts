...
@Component({
  selector: "app-trans-logistics-dashboard",
  templateUrl: "./trans-logistics-dashboard.component.html",
  styleUrls: ["./trans-logistics-dashboard.component.scss"],
})
export class TransLogisticsDashboardComponent implements OnInit {
  user: string;
  index: number;
  rfqStat = [];

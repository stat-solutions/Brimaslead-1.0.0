...
@Component({
  selector: "app-trans-logistics-profile",
  templateUrl: "./trans-logistics-profile.component.html",
  styleUrls: ["./trans-logistics-profile.component.scss"],
})
export class TransLogisticsProfileComponent implements OnInit {
  ...
  save(): any {
    ...
    //           this.alertService.success({
    //             html:
    //               "<b> Email was edited successfully, please check your email to verify your account<b>",
    //           });
    //         },
    //         (err) => {
    //           this.errored = true;

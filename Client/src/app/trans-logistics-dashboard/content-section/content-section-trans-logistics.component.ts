...
@Component({
  ...
  templateUrl: './content-section-trans-logistics.component.html',
  styleUrls: ['./content-section-trans-logistics.component.scss']
})
export class ContentSectionTransLogisticsComponent implements OnInit {

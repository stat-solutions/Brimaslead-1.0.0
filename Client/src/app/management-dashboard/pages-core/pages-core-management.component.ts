...
@Component({
  selector: 'app-pages-core-management',
  templateUrl: './pages-core-management.component.html',
  styleUrls: ['./pages-core-management.component.scss']
})
export class PagesCoreManagementComponent implements OnInit {
  setNavLayout: string;
  themeLayout: string;

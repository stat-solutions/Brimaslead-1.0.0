...
@Component({
  ...
  templateUrl: './right-panel-management.component.html',
  styleUrls: ['./right-panel-management.component.scss'],
})
export class RightPanelManagementComponent implements OnInit {

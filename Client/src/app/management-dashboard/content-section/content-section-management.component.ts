...
@Component({
  ...
  templateUrl: './content-section-management.component.html',
  styleUrls: ['./content-section-management.component.scss']
})
export class ContentSectionManagementComponent implements OnInit {

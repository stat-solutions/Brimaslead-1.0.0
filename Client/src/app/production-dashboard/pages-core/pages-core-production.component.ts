...
@Component({
  selector: 'app-pages-core-production',
  templateUrl: './pages-core-production.component.html',
  styleUrls: ['./pages-core-production.component.scss']
})
export class PagesCoreProductionComponent implements OnInit {
  setNavLayout: string;
  themeLayout: string;

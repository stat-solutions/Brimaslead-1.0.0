...
@Component({
  ...
  templateUrl: './right-panel-production.component.html',
  styleUrls: ['./right-panel-production.component.scss'],
})
export class RightPanelProductionComponent implements OnInit {

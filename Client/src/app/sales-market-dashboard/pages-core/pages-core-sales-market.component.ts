...
@Component({
  selector: 'app-pages-core-sales-market',
  templateUrl: './pages-core-sales-market.component.html',
  styleUrls: ['./pages-core-sales-market.component.scss']
})
export class PagesCoreSalesMarketComponent implements OnInit {
  setNavLayout: string;
  themeLayout: string;

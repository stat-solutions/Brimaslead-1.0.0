...
@Component({
  selector: 'app-sales-market-dashboard',
  templateUrl: './sales-market-dashboard.component.html',
  styleUrls: ['./sales-market-dashboard.component.scss']
})
export class SalesMarketDashboardComponent implements OnInit {

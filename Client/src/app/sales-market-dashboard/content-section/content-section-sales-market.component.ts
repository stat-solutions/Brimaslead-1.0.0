...
@Component({
  ...
  templateUrl: './content-section-sales-market.component.html',
  styleUrls: ['./content-section-sales-market.component.scss']
})
export class ContentSectionSalesMarketComponent implements OnInit {

...
@Component({
  ...
  templateUrl: './right-panel-sales-market.component.html',
  styleUrls: ['./right-panel-sales-market.component.scss'],
})
export class RightPanelSalesMarketComponent implements OnInit {

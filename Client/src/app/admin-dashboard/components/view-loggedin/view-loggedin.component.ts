...
@Component({
  selector: "app-view-loggedin",
  templateUrl: "./view-loggedin.component.html",
  styleUrls: ["./view-loggedin.component.scss"],
})
export class ViewLoggedinComponent implements OnInit {

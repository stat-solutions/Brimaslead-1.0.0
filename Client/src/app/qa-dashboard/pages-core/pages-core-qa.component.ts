...
@Component({
  selector: 'app-pages-core-qa',
  templateUrl: './pages-core-qa.component.html',
  styleUrls: ['./pages-core-qa.component.scss']
})
export class PagesCoreQaComponent implements OnInit {
  setNavLayout: string;
  themeLayout: string;

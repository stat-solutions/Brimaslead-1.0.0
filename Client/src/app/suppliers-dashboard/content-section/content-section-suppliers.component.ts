...
@Component({
  ...
  templateUrl: './content-section-suppliers.component.html',
  styleUrls: ['./content-section-suppliers.component.scss']
})
export class ContentSectionSuppliersComponent implements OnInit {

...
@Component({
  selector: 'app-pages-core-suppliers',
  templateUrl: './pages-core-suppliers.component.html',
  styleUrls: ['./pages-core-suppliers.component.scss']
})
export class PagesCoreSuppliersComponent implements OnInit {
  setNavLayout: string;
  themeLayout: string;

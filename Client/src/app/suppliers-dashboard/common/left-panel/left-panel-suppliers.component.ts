...
@Component({
  ...
  templateUrl: './left-panel-suppliers.component.html',
  styleUrls: ['./left-panel-suppliers.component.scss']
})
export class LeftPanelSuppliersComponent implements OnInit {

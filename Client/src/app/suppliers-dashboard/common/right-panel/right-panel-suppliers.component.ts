...
@Component({
  ...
  templateUrl: './right-panel-suppliers.component.html',
  styleUrls: ['./right-panel-suppliers.component.scss'],
})
export class RightPanelSuppliersComponent implements OnInit {

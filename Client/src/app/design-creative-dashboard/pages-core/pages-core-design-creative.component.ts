...
@Component({
  selector: 'app-pages-core-design-creative',
  templateUrl: './pages-core-design-creative.component.html',
  styleUrls: ['./pages-core-design-creative.component.scss']
})
export class PagesCoreDesignCreativeComponent implements OnInit {
  setNavLayout: string;
  themeLayout: string;

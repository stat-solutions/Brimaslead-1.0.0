...
@Component({
  ...
  templateUrl: './content-section-design-creative.component.html',
  styleUrls: ['./content-section-design-creative.component.scss']
})
export class ContentSectionDesignCreativeComponent implements OnInit {

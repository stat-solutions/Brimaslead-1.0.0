...
@Component({
  ...
  templateUrl: './right-panel-design-creative.component.html',
  styleUrls: ['./right-panel-design-creative.component.scss'],
})
export class RightPanelDesignCreativeComponent implements OnInit {

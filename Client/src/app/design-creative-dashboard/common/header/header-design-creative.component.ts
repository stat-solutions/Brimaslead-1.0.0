...
@Component({
  selector: "app-header",
  templateUrl: "./header-design-creative.component.html",
  styleUrls: ["./header-design-creative.component.scss"],
})
export class HeaderDesignCreativeComponent implements OnInit {
